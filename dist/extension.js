...
// src/extension.ts
async function getLastCommitInfo(workspaceRoot) {
  try {
...
var VelocityReviewSidebarProvider = class {
      ...
      switch (element.contextValue) {
        ...
        case "changed-files":
          if (this.gitCommitInfo && this.gitCommitInfo.changedFiles.length > 0) {
            return Promise.resolve(
              this.gitCommitInfo.changedFiles.map(
                (file) => new VelocityReviewItem(file, vscode.TreeItemCollapsibleState.None, "file")
              )
            );
          }
          return Promise.resolve([
...
var VelocityReviewItem = class extends vscode.TreeItem {
